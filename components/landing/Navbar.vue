            ...
            <div class="text-right space-y-1">
              <div class="flex items-center justify-end space-x-1.5">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-3.5 w-3.5"
                  :class="isScrolled ? 'text-gray-900' : 'text-gray-300'" fill="none" viewBox="0 0 24 24"
                  stroke="currentColor">
              ...
              <div class="flex items-center justify-end space-x-1.5">
                ...
                <a href="mailto:botintegratedservices@gmail.com"
                  :class="isScrolled ? 'text-gray-700 hover:text-[#D2691E]' : 'text-gray-200 hover:text-white'"
                  class="text-sm font-medium transition-colors">
        ...
        <div v-show="open" class="md:hidden mt-2 py-2 rounded-lg shadow-lg bg-white/95">
          ...
          <div class="px-4 py-3 border-t border-gray-200 mt-2">
            ...
            <div class="flex items-center space-x-2">
              ...
              <a href="mailto:botintegratedservices@gmail.com"
                class="text-xs text-gray-700 hover:text-[#D2691E]">botintegratedservices@gmail.com</a>
            </div>
          </div>
        </div>
      </transition>
